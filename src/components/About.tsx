...
const About = () => {
  const features = [
    {
      icon: <Lightbulb className="w-8 h-8 text-viz-primary" />,
      title: "Learn from Experts",
      desc: "Industry professionals with real experience."
    },
    {
      icon: <Rocket className="w-8 h-8 text-viz-primary" />,
      title: "Hands-on Projects",
      desc: "Portfolio-ready practical projects step by step."
    },
    {
      icon: <Award className="w-8 h-8 text-viz-primary" />,
      title: "Career Growth",
      desc: "Upgrade your skills and get hired."
    },
    {
      icon: <Users className="w-8 h-8 text-viz-primary" />,
    ...
    <section id="about" className="py-section bg-white">
      <div className="max-w-[1560px] mx-auto px-6 md:px-10 lg:px-12 xl:px-16 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
        ...
        <div className="animate-fade-up">
          <p className="text-viz-primary font-bold text-sm tracking-widest uppercase mb-4">
            About Us
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 animate-fade-up delay-200">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-12 h-12 shrink-0 rounded-full border border-viz-primary/30 flex items-center justify-center transition-transform duration-300 group-hover:-translate-y-1 bg-white">
                {feature.icon}
              </div>
              <div>
